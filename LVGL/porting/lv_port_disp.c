...
//__attribute__((section(".lvgl_buf")))
//static lv_color_t buf_2_1[MY_DISP_HOR_RES * MY_DISP_VER_RES * 5 / 6];

//__attribute__((section(".lvgl_buf")))
//static lv_color_t buf_2_2[MY_DISP_HOR_RES * MY_DISP_VER_RES * 5 / 6];

//lv_disp_draw_buf_init(&draw_buf_dsc_2, 
//                      buf_2_1,
//                      buf_2_2,
//                      MY_DISP_HOR_RES * MY_DISP_VER_RES * 5 / 6);

//      #define PIXELS_FULL (MY_DISP_HOR_RES * MY_DISP_VER_RES)

//      static lv_color_t buf_3_1[PIXELS_FULL] __attribute__((at(EXT_SRAM_BASE)));
//      static lv_color_t buf_3_2[PIXELS_FULL] __attribute__((at(EXT_SRAM_BASE + PIXELS_FULL * sizeof(lv_color_t))));

//      static lv_disp_draw_buf_t draw_buf_dsc_2;
//      lv_disp_draw_buf_init(&draw_buf_dsc_2, buf_3_1, buf_3_2, PIXELS_FULL);
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    TFTLCD_Set_Coordinate(x1, x2, y1, y2);
    LCD_DMA_Transform((uint32_t)color_p,size);
    }
